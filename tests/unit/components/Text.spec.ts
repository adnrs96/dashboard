...
describe('Text.vue', () => {
  ...
  it('should have the good font-size', () => {
    ...
    expect(p4.classes('text-s')).toBeTruthy()
    expect(p5.classes('text-xs')).toBeTruthy()
    expect(p6.classes('text-2xs')).toBeTruthy()
  })
  ...
  it('should have the good line-height', () => {
    ...
    expect(h1.classes('leading-60')).toBeTruthy()
    expect(h2.classes('leading-34')).toBeTruthy()
    expect(p1.classes('leading-27')).toBeTruthy()
    expect(p2.classes('leading-26')).toBeTruthy()
    expect(p2medium.classes('leading-24')).toBeTruthy()
    expect(p3.classes('leading-22')).toBeTruthy()
    expect(p4.classes('leading-13')).toBeTruthy()
    expect(p5.classes('leading-18')).toBeTruthy()
    expect(p6.classes('leading-15')).toBeTruthy()
  })
})
